...
const ALIASES: Record<string, string[]> = {
  ...
  hea: ["hea"], bra: ["bra"], ref: ["ref"], oneVOne: ["1v1"], cmd: ["cmd"], kic: ["kic"], thr: ["thr"],
  han: ["han"], aer: ["aer"], consistency: ["consistency", "cons"], importantMatches: ["important matches", "imp matches", "imp m"],
