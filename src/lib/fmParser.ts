...
const ALIASES: Record<string, string[]> = {
  ...
  height: ["height"], valueM: ["transfer value", "value"], wageK: ["wage"], currentAbility: ["ca", "current ability"], potentialAbility: ["pa", "potential ability"], minutes: ["mins", "minutes"], apps: ["apps", "appearances", "apps."], goals: ["goals", "gls"], assists: ["assists", "asts", "ast"],
  averageRating: ["av rat", "average rating"], uid: ["uid"],
  acc: ["acc", "acceleration"], pac: ["pac", "pace"], sta: ["sta", "stamina"], wor: ["wor", "work rate"], cro: ["cro", "crossing"], dri: ["dri", "drb", "dribbling"],
  nat: ["nat", "natural fitness"],
  otb: ["otb", "off the ball"], tck: ["tck", "tackling"], mar: ["mar", "marking"], pos: ["pos", "positioning"], ant: ["ant", "anticipation"], cnt: ["cnt", "concentration"],
  dec: ["dec", "decisions"], fir: ["fir", "first touch"], pas: ["pas", "passing"], tec: ["tec", "technique"], vis: ["vis", "vision"], cmp: ["cmp", "com", "composure"],
  fla: ["fla", "flair"], fin: ["fin", "finishing"], lon: ["lon", "long shots"], agi: ["agi", "agility"], bal: ["bal", "balance"], str: ["str", "strength"], jum: ["jum", "jumping reach"],
  hea: ["hea", "heading"], bra: ["bra", "bravery"], cor: ["cor", "corners"], fre: ["fre", "free kick taking", "free kicks"], lth: ["l th", "long throws"], pen: ["pen", "penalty taking", "penalties"], agg: ["agg", "aggression"], ldr: ["ldr", "leadership"],
  ref: ["ref", "reflexes"], oneVOne: ["1v1", "one on ones", "one-on-ones"], cmd: ["cmd", "command of area"], kic: ["kic", "kicking"], thr: ["thr", "throwing"],
  han: ["han", "handling"], aer: ["aer", "aerial reach"], com: ["com", "communication"], ecc: ["ecc", "eccentricity"], pun: ["pun", "punching", "punching tendency"], tro: ["tro", "tendency to rush out", "rushing out"],
